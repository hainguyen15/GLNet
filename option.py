...
class Options:
    def __init__(self):
        ...
        parser.add_argument(
            ...
            default=1,
            choices=[1, 2, 3],
            help="mode for training procedure. 1: train global branch only. 2: train local branch with fixed global branch. 3: train global branch with fixed local branch",
        )
        parser.add_argument(
